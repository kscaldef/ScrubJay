const californiaFilter = [
  ...
  { species: 'Cackling Goose (Aleutian)' },
  { species: 'Greater White-fronted x Cackling Goose (hybrid)' },
  { species: 'Canada Goose' },
  { species: 'Canada Goose (moffitti/maxima)' },
  { species: 'Canada Goose (canadensis Group)' },
  { species: 'Canada Goose (occidentalis/fulva)' },
  ...
  { species: 'Green-winged Teal (Eurasian)' },
  ...
  { species: 'Band-tailed Pigeon (Northern)' },
  ...
  { species: 'Sandhill Crane (canadensis)' },
  { species: 'Black-necked Stilt' },
  { species: 'Black-necked Stilt (Black-necked)' },
  ...
  { species: 'Bar-tailed Godwit (Siberian)' },
  ...
  { species: 'California Gull (californicus)' },
  { species: 'California Gull (albertaensis)' },
  { species: 'Herring Gull' },
  { species: 'Iceland Gull' },
  { species: "Iceland Gull (Thayer's)" },
  ...
  { species: 'Glaucous x Glaucous-winged Gull (hybrid)' },
  ...
  { species: 'Brown Pelican (California)' },
  ...
  { species: 'Turkey Vulture (Northern)' },
  { species: 'Osprey' },
  ...
  { species: 'Red-breasted Sapsucker (daggetti)' },
  ...
  { species: 'Hairy Woodpecker (Pacific)' },
  ...
  { species: 'Northern Flicker (Red-shafted)' },
  { species: 'Northern Flicker (Yellow-shafted)' },
  { species: 'Northern Flicker (Yellow-shafted x Red-shafted)' },
  { species: 'Gilded Flicker' },
  { species: 'Northern x Gilded Flicker (hybrid)' },
  { species: 'Yellow-headed Caracara' },
  { species: 'American Kestrel' },
  { species: 'Merlin' },
  { species: 'Merlin (Black)' },
  { species: 'Merlin (Prairie)' },
  { species: 'Peregrine Falcon' },
  { species: 'Peregrine Falcon (Tundra)' },
  { species: 'Peregrine Falcon (North American)' },
  ...
  { species: 'Western Flycatcher (Pacific-slope)' },
  { species: 'Western Flycatcher (Cordilleran)' },
  { species: 'Black Phoebe' },
  { species: 'Black Phoebe (Northern)' },
  { species: 'Eastern Phoebe' },
  { species: "Say's Phoebe" },
  { species: "Black x Say's Phoebe (hybrid)" },
  { species: 'Vermilion Flycatcher' },
  { species: 'Vermilion Flycatcher (Northern)' },
  ...
  { species: 'White-breasted Nuthatch (Pacific)' },
  { species: 'Pygmy Nuthatch' },
  { species: 'Brown Creeper' },
  { species: 'Brown Creeper (occidentalis Group)' },
  { species: 'Blue-gray Gnatcatcher' },
  { species: 'Blue-gray Gnatcatcher (obscura Group)' },
  { species: 'Black-tailed Gnatcatcher' },
  { species: 'California Gnatcatcher' },
  { species: 'Rock Wren' },
  { species: 'Rock Wren (Northern)' },
  { species: 'Canyon Wren' },
  { species: 'House Wren' },
  { species: 'Pacific Wren' },
  { species: 'Marsh Wren' },
  { species: 'Marsh Wren (paludicola Group)' },
  { species: "Bewick's Wren" },
  { species: "Bewick's Wren (spilurus Group)" },
  { species: 'Cactus Wren' },
  ...
  { species: "Swainson's Thrush (Olive-backed)" },
  { species: 'Hermit Thrush' },
  { species: 'American Robin' },
  { species: 'American Robin (migratorius Group)' },
  ...
  { species: 'Red Crossbill (Ponderosa Pine or type 2)' },
  { species: 'Red Crossbill (Western Hemlock or type 3)' },
  { species: 'Red Crossbill (Douglas-fir or type 4)' },
  { species: 'Red Crossbill (Lodgepole Pine or type 5)' },
  ...
  { species: 'Fox Sparrow' },
  { species: 'Fox Sparrow (Thick-billed)' },
  { species: 'Dark-eyed Junco' },
  { species: 'Dark-eyed Junco (Pink-sided)' },
  { species: 'Dark-eyed Junco (Oregon)' },
  { species: 'Dark-eyed Junco (Slate-colored)' },
  { species: 'Dark-eyed Junco (Slate-colored/cismontanus)' },
  { species: 'Dark-eyed Junco (cismontanus)' },
  { species: 'Dark-eyed Junco (Gray-headed)' },
  { species: 'White-crowned Sparrow' },
  { species: 'White-crowned Sparrow (oriantha)' },
  { species: "White-crowned Sparrow (Gambel's)" },
  { species: 'White-crowned Sparrow (Dark-lored)' },
  { species: 'White-crowned Sparrow (Yellow-billed)' },
  ...
  { species: "Nelson's Sparrow (Interior)" },
  { species: 'Savannah Sparrow' },
  { species: 'Savannah Sparrow (Large-billed)' },
  { species: 'Song Sparrow' },
  { species: 'Song Sparrow (pusillula)' },
  { species: 'Song Sparrow (rufina Group)' },
  { species: 'Song Sparrow (heermanni Group)' },
  { species: 'Song Sparrow (montana/merrilli)' },
  ...
  { species: 'Hooded Oriole (nelsoni Group)' },
  ...
  { species: 'Red-winged Blackbird (California Bicolored)' },
  ...
  { species: 'Orange-crowned Warbler (lutescens)' },
  { species: 'Orange-crowned Warbler (sordida)' },
  { species: 'Orange-crowned Warbler (celata)' },
  { species: "Lucy's Warbler" },
  { species: 'Nashville Warbler' },
  { species: 'Nashville Warbler (ridgwayi)' },
  ...
  { species: 'Palm Warbler (Western)' },
  { species: 'Pine Warbler' },
  { species: 'Yellow-rumped Warbler' },
  { species: 'Yellow-rumped Warbler (Myrtle)' },
  { species: "Yellow-rumped Warbler (Audubon's)" },
  { species: "Yellow-rumped Warbler (Myrtle x Audubon's)" },
  ...
  { species: "Wilson's Warbler (pileolata)" },
...
export default californiaFilter;
